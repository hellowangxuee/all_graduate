...
class total():
    def __init__(self):
        self.x = [i for i in range(5, 105, 5)]
        self.y = [[],[],[],[]]
    ...
    def drawPicture(self):
        ...
        y2 = []
        for i in range(10):
            y1.append(random.randrange(10))
            y2.append(random.randrange(10))
        x1 = range(0, 10)
        plt.plot(x1, y1, label = 'First line', linewidth = 3, color = 'r', marker = 'o',  markersize = 12)
    ...
    def draw_Runtime(self):
        ...
        plt.plot(self.x, self.y[3], label='HIS_BICC', marker='o', color='y')
        plt.xlabel("k_value")
        plt.ylabel("Runtime")
        plt.legend()
