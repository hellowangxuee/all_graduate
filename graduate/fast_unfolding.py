...
def setData(filename):
    f = open(filename,'a+')
    for i in range(200):
        ran1 = random.randrange(0,101,1)
        ran2 = random.randrange(0,101,1)
        f.write(str(ran1) + ' ' + str(ran2) + '\n')

    f.close()


if __name__ == "__main__":
    setData("Twitter/test.txt")
    vector_dict, edge_dict=loadData("Twitter/test.txt")
